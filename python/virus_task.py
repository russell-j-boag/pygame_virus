...
BLOCKS = [
    ...
    #     TARGET_ACC=CALIBRATION_TARGET_ACCURACY,  # target accuracy for adaptive staircase
    ...
    dict(
        ...
        TARGET_ACC=CALIBRATION_TARGET_ACCURACY,  # not used (staircase off), but harmless
        FIXED_DELTA_ON=True,
        FIXED_DELTA_VALUE=0.10,   # not used here, but harmless
        TRIAL_FEEDBACK_ON=True,
